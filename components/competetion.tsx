                  ...
                  <Card className="border-emerald-800/20 bg-emerald-900/10 backdrop-blur">
                    <CardHeader>
                      ...
                      <CardDescription className="text-emerald-100/70">
                        Participants will receive a set of experimental tasks to
                        complete.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ul className="list-disc space-y-2 pl-4 text-emerald-100/80">
                        <li>
                          {" "}
                          Format: Participants will perform a laboratory
                          experiment.
                        </li>
                        <li>
                          Scoring: The maximum score for this round is 30
                          points.
                        </li>
                ...
                <div className="ml-16 md:ml-[50%] md:pl-8">
                  <Card className="border-emerald-800/20 bg-emerald-900/10 backdrop-blur">
                    <CardHeader>
                      ...
                      <CardDescription className="text-emerald-100/70">
                        Students are provided with all necessary
                        assets(scientific calculator, periodic table, pen,
                        paper).
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ul className="list-disc space-y-2 pl-4 text-emerald-100/80">
                        <li>
                          {" "}
                          Format: Participants will solve 8 written problems
                          covering various areas of chemistry.
                        </li>
                        <li>
                          Scoring: Each problem is worth 10 points, making the
                          total 80 points.
                        </li>
